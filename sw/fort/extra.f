...
C                                                                       
      ...
      CALL RRTMERR('extra.f:103:STOPPED IN XSREAD',29)
C                                                                       
   30    CONTINUE                                                       
         IXFLG(I) = 0                                                   
   40 CONTINUE                                                          
