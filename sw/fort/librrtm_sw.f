...
C     ***    Calculate information needed by the radiative transfer rout
...
c     Validates input.
      ...
      CALL RRTMERR('librrtm_sw.f:107:',17)
      endif
      isccos = icos
...
C     No cross-sections implemented in shortwave.
      ...
      CALL RRTMERR('librrtm_sw.f:121:',17)
      ENDIF
...
C     Set up the sun!
 ...
 1475    CONTINUE
      ...
      CALL RRTMERR('librrtm_sw.f:147:',17)
      ENDIF
...
Cf2py intent(in) semissinp
 ...
 1700    CONTINUE
      ...
      CALL RRTMERR('librrtm_sw.f:219:',17)
      ENDIF
...
Cf2py intent(in) WBRODLINP
     ...
     *                RADCN1,RADCN2 
     ...
     &                  COLMOL(MXLAY),NMOL
      ...
      CALL RRTMERR('librrtm_sw.f:277:',17)
      ENDIF
