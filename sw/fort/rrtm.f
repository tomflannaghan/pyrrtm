...
C     Test for mixing ratio input.
 ...
 8800 CONTINUE
      CALL RRTMERR('rrtm.f:528: INVALID INPUT_RRTM ',31)
...
C     dn	 	: Julian day
C     earth_sun_ratio 	: square of the ratio of mean to actual Earth-Sun
...
c   use Iqbal's equation 1.2.1 
	...
	earth_sun= 1.000110 + .034221 * cos(gamma) + 
     &   .001289 * sin(gamma) +
