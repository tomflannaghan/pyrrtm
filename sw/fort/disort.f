...
c $Header: /storm/rc1/cvsroot/rc/rrtm_sw/src/disort.f,v 2.4 2004/04/15 1
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
C     SUCH THAT X IS BETWEEN XX(J) AND XX(J+1). XX(1:N) MUST BE MONOTONI
C     IN EITHER ASCENDING OR DESCENDING ORDER. A VALUE OF RETURNED OF J=
