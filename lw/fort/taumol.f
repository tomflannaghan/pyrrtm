...
*        Michael J. Iacono, Ronald E. Farren, Luke Chen, Robert Bergstro
*                                                                       
************************************************************************
*     TAUMOL                                                            
*                                                                       
*     This file contains the subroutines TAUGBn (where n goes from      
*     1 to 16).  TAUGBn calculates the optical depths and Planck fractio
...
*     SELFFAC - scale factor needed for water vapor self-continuum, equa
...
*               temperatures needed for the foreign-continuum interpolat
*                                                                       
*  Data input                                                           
*     COMMON /Kn/ KA(NSPA(n),5,13,MG), KB(NSPB(n),5,13:59,MG), SELFREF(1
*                 FORREF(4,MG), KA_M'MGAS', KB_M'MGAS'                  
*        (note:  n is the band number,'MGAS' is the species name of the 
*         gas)                                                          
*                                                                       
*     Description:                                                      
...
C     Compute the optical depth by interpolating in ln(pressure) and 
C     temperature, and appropriate species.  Below LAYTROP, the water va
C     self-continuum and foreign continuum is interpolated (in temperatu
C     separately.
...
c     In atmospheres where the amount of N2O is too great to be consider
c     a minor species, adjust the column amount of N2O by an empirical f
...
C     vapor self-continuum and foreign continuum is interpolated (in tem
C     separately.
...
C EMPIRICAL MODIFICATION TO CODE TO IMPROVING STRATOSPHERIC COOLING RATE
C FOR CO2.
...
C                           (high key - nothing; high minor - CFC11, CFC
...
C     CFC11 is multiplied by 1.385 to account for the 1060-1107 cm-1 ban
...
c     In atmospheres where the amount of CO2 is too great to be consider
c     a minor species, adjust the column amount of CO2 by an empirical f
c     to obtain the proper contribution.
...
C     Original CFC22 is multiplied by 1.485 to account for the 780-850 c
