...
C  ---------------------------------------------------------------------
      ...
      DATA HVRKG14  / '$Revision: 3.2 $' /
      DATA HNAMKG14 / '         k_gB14.f:' /

C     The array KA contains absorption coefs for each of the 16 g-interv
...
C     from 1 to 10, and corresponds to different gas column amount ratio
...
C     to that of gas2.
C     The 2nd index in the array, JT, which runs from 1 to 5, correspond
C     to different temperatures.  More specifically, JT = 3 means that t
