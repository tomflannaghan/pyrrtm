...
c --------------------------------------------------------------------
      ...
      SELECT CASE (I)
        ...
        CASE (5)
          D1MACH = LOG10(B)
        CASE DEFAULT
      CALL RRTMERR('RDI1MACH.f:176:D1MACH -- input arg out of bound',48)
      END SELECT
...
c --------------------------------------------------------------------
      ...
      SELECT CASE (I)
        ...
        CASE (3)
      CALL RRTMERR('RDI1MACH.f:255:I1MACH: input arg = 3 is obsolet',48)
        CASE (4)
          I1MACH = 0 ! Error message unit
        CASE (5)
          I1MACH = BIT_SIZE(I)
        CASE (6)
      CALL RRTMERR('RDI1MACH.f:261:I1MACH: input arg = 6 is obsolet',48)
        CASE (7)
          I1MACH = RADIX(1)
        CASE (8)
          I1MACH = BIT_SIZE(I) - 1
        ...
        CASE DEFAULT
      CALL RRTMERR('RDI1MACH.f:283:I1MACH: input argument out of bo',51)
      END SELECT
