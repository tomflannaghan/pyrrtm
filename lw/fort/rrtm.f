...
C     Read in cloud input option.  
 ...
 1000 CONTINUE
      ...
      IF (LAY .LE. NPRELAY)
     &CALL RRTMERR('rrtm.f:644:CLD LAYERS NOT IN ASCENDING ORDER',44)
     ...
     &CALL RRTMERR('rrtm.f:653:CLDFRAC MUST BE 1 WHEN USING DISORT',46)
